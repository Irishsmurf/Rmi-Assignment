...
{ 
    ...
    {
        try{
            String[] slots = obj.getAppointments(day);
    ...
    {
        try{
            String[] slots = obj.getAppointments(7);
            ObservableList<RmiClientUI.Appointment> ret = FXCollections.observableArrayList();
            for(String tmp : slots)
            {
                String[] delim = tmp.split(" ");
    ...
    {
        URL url = new URL("http://localhost:9876/distro?wsdl");
        QName qname = new QName("http://distro.paddez.com/", "RmiClinicService");
        Service service = Service.create(url, qname);
        this.obj = service.getPort(RmiClinicInf.class);
        System.out.println(obj.connectable() + " test");
        System.out.println(obj.getInfo(10, 30, 3));
    }
}
...
//Initial Login Screen
    ...
    public void openDayScreen(final Stage primaryStage, int day)
    {
        ...
        patient.setCellValueFactory( new PropertyValueFactory<Appointment, String>("patient"));
